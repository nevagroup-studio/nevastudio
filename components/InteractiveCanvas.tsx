...
const ResizeHandle: React.FC<{
    ...
    <div
      className={`absolute w-4 h-4 bg-white border-2 border-cyan-300/50 rounded-full z-20 ${position}`}
      style={{ cursor }}
                ...
                return (
                    ...
                    >
                        ...
                        {isSelected && !isCanvaLayoutLocked && (
                            <>
                                <div className="absolute inset-0 border-2 border-dashed border-cyan-300/50 pointer-events-none"></div>
